...
class Student:
    def __init__(self,root):
        ...
        # first image
        img=Image.open(r"D:\Projects\IIITDM Student Management System\college_images\face-recognition.png")
        ...
        title_lbl = Label(bg_img, text="STUDENT FACE MANAGEMENT SYSTEM ",font=("times new roman",35,"bold"),bg="white",fg="blue" )
        ...
        # Department
        department_label = Label(current_course_frame,text="Department",font=("times new roman",12,"bold"))
        ...
        department_combo["values"]=("Select Department","CSE","AI&DS","ME","ECE")
        department_combo.current(0)
        department_combo.grid(row=0, column=1,padx=3,pady=10, sticky=W)
        ...
        course_combo["values"]=("Select Courses","DSA","ML","Sensors & Controls","AI","Power Electronics", "D.M.", "Theory of Machines", "Automation", "Rocket Propulsion")
        ...
        studentID_entry=Entry(class_student_frame,textvariable=self.var_std_id,width=20,font=("times new roman",13,"bold"), bg="white")
        ...
        #  Blood Group (div)
        blood_grp_label = Label(class_student_frame, text="BloodGroup: ", font=("times new roman",13,"bold"), bg="white" )
        blood_grp_label.grid(row=1, column=0, padx=10, pady=5, sticky=W)
        
        blood_grp_entry = Entry(class_student_frame,textvariable=self.var_div, width=20, font=("times new roman",13,"bold"), bg="white" )
        blood_grp_entry.grid(row=1, column=1, padx=10, pady=5, sticky=W)
        ...
        dob_entry = Entry(class_student_frame,textvariable=self.var_dob, width=20, font=("times new roman",13,"bold"), bg="white" )
        ...
        gender_combo["values"]=("Select Gender","Male","Female","Transgender","Rather Not to say")
        gender_combo.current(0)
        gender_combo.grid(row=1, column=3,padx=8,pady=10, sticky=W)
        ...
        RollNo_entry = Entry(class_student_frame,textvariable=self.var_roll, width=20, font=("times new roman",13,"bold"), bg="white" )
        RollNo_entry.grid(row=2, column=1, padx=10, pady=5, sticky=W)
        
        # EMAIL 
        emial_label = Label(class_student_frame, text="Email:", font=("times new roman",13,"bold"), bg="white")
        emial_label.grid(row=2, column=2, padx=10, pady=5, sticky=W)
        
        emial_entry = Entry(class_student_frame,textvariable=self.var_email, width=20, font=("times new roman",13,"bold"), bg="white" )
        emial_entry.grid(row=2, column=3, padx=10, pady=5, sticky=W)
        ...
        phone_no_entry = Entry(class_student_frame,textvariable=self.var_phone, width=20, font=("times new roman",13,"bold"), bg="white" )
        ...
        address_entry = Entry(class_student_frame, width=20,textvariable=self.var_address, font=("times new roman",13,"bold"), bg="white" )
        ...
        teacher_name_entry = Entry(class_student_frame,textvariable=self.var_teacher, width=20, font=("times new roman",13,"bold"), bg="white" )
        ...
        btn_frame.place(x=0, y=205, width=735, height=35)
        ...
        update_photo_btn = Button(btn_frame1, text="Update Photo Button", width = 36, font=("times new roman",13,"bold"), bg="blue", fg="white" )
        ...
        img_right = Image.open(r"D:\Projects\IIITDM Student Management System\college_images\std5.jpg")
        ...
        search_frame.place(x=5,y=150,width=675,height=70)
        ...
        search_entry = Entry(search_frame, width=14, font=("times new roman",13,"bold"), bg="white" )
        ...
        table_frame.place(x=5,y=220,width=675,height=329)
        ...
        self.student_table.heading("div",text="Blood Group")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Success", "Students details has been saved successfully ", parent=self.root)
    ...
    def generate_dataset(self):
            ...
            try:
                ...
                while True:                                       
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        file_name_path = "D:\Projects\IIITDM Student Management System/data/user."+str(idvar)+"."+str(img_id)+".jpg"
                        cv2.imwrite(file_name_path, face)
                        cv2.putText(face, str(img_id),(50,50),cv2.FONT_HERSHEY_COMPLEX,2,(0,255,0),2)
                        cv2.imshow("Croppeed Face", face)
        ...
        # error :: update nahi ho raha hai, photo link nahi kr rha hai roll number ke saath
